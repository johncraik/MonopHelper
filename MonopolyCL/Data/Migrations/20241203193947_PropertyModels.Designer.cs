...
namespace MonopolyCL.Data.Migrations
{
    ...
    [Migration("20241203193947_PropertyModels")]
    partial class PropertyModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonopolyCL.Models.Properties.DataModel.GameToProperty", b =>
                {
                    b.Property<int>("GameId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("GameId", "PropertyName", "TenantId");

                    b.HasIndex("PropertyName", "TenantId");

                    b.ToTable("GamesToProperties");
                });
            ...
            modelBuilder.Entity("MonopolyCL.Models.Properties.DataModel.GameToProperty", b =>
                {
                    b.HasOne("MonopolyCL.Models.Properties.DataModel.GameProperty", "GameProp")
                        .WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
